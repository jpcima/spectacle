...
KnobSkin::KnobSkin(const unsigned char *pngData, unsigned pngSize, unsigned imageCount)
    : fSurface(cairo_image_surface_create_from_png_data((const char *)pngData, pngSize)),
